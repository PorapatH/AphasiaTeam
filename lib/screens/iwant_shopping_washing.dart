...
class WantShoppingWashing extends StatefulWidget{
   @override
  _WantShoppingWashingState createState() => _WantShoppingWashingState();
}
class _WantShoppingWashingState extends State<WantShoppingWashing>{
  ...
  void initState() {
    ...
    super.initState();
    readIwshoppingWashing();
  }

  Future<void> readIwshoppingWashing() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var shoppingwashing = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Shopping')
        .doc('lP19j7Q1CWR1UMNzIFP8')
        .collection('Washing')
        .orderBy('Wsid');

    await shoppingwashing.snapshots().listen((response) {
      List<DocumentSnapshot> snapshots = response.docs;
      for (var snapshot in snapshots) {
        print('snapshot = $snapshot');
        print('Washing = ${snapshot['Wsname']}');
  ...
  Widget showImage(int index) {
    String picwashingsp = iwantModels[index].washing_pic;
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
        children: [
          picwashingsp != null ? Image.network(picwashingsp) : Container(),
        ],
      ),)
    );
  }
  ...
  Widget showText(int index) {
    String iwspwashing = iwantModels[index].washing;
        ...
        appBar: new AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => WantShoppingWashing()),
              );
            },
          ),
                ...
                child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (BuildContext context) => IwashoppingWashingTts(),
                          settings:
...
///
///
class IwashoppingWashingTts extends StatefulWidget {
  @override
  _IwashoppingWashingTtsState createState() => _IwashoppingWashingTtsState();
}

class _IwashoppingWashingTtsState extends State<IwashoppingWashingTts> {
  bool isfav = false;
  @override
  Widget build(BuildContext context) {
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.washing_pic,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการซื้อ' + args.washing);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                     ...
                     child: isfav ? Text("นำออกจากรายการโปรด", style: TextStyle(fontSize: 20,),) : Text("เพิ่มในรายการโปรด", style: TextStyle(fontSize: 20,),),
                      onPressed: () {
                        ...
                        if (isfav == true) {
                          var img = args.washing_pic;
                          var message = 'ฉันต้องการซื้อ' + args.washing;
                          ...
                          var deleteImg = args.washing_pic;
                          var delete = 'ฉันต้องการซื้อ' + args.washing;

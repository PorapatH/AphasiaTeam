...
class WantEatSingledish extends StatefulWidget{
 @override
  _WantEatSingledishState createState() => _WantEatSingledishState();
}
class _WantEatSingledishState extends State<WantEatSingledish>{
  ...
  Future<void> readIwEatmain() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantmain = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Foods')
        .doc('84BtJA8RKVnMBlTJLBRZ')
        .collection('Singledish')
        .orderBy('Sdid');

    await iwantmain.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picmain = iwantModels[index].singledish_pic;
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
        children: [
          picmain!= null ? Image.network(picmain) : Container(),
        ],
      ),)
    );
  }
  ...
  Widget showText(int index) {
    String iwmain = iwantModels[index].singledish_foods;
...
class _IwantTtsState extends State<IwantTts> {
  ...
  Widget build(BuildContext context) {
    ...
    String pic = args.singledish_pic;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.singledish_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการกิน' + args.singledish_foods,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการกิน' + args.singledish_foods);
                        },
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      onPressed: () {
                        ...
                        if (isfav == true) {
                          var img = args.singledish_pic;
                          var message = 'ฉันต้องการกิน' + args.singledish_foods;
                          ...
                          var deleteImg = args.singledish_pic;
                          var delete = 'ฉันต้องการกิน' + args.singledish_foods;

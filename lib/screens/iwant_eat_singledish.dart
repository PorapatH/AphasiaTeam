...
class _WantEatSingledishState extends State<WantEatSingledish> {
  ...
  Widget showImage(int index) {
    String picsingledish = iwantModels[index].singledish_pic;

    if (picsingledish != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picsingledish != null
                    ? Image.network(picsingledish)
                    : Container(),
              ],
            ),
          ));
    } else if (picsingledish == null) {
      return Container(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (isfav == true) {
                            ...
                            var message =
                                'ฉันต้องการกิน' + args.singledish_foods;

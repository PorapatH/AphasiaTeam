...
class WantEatSteamed extends StatefulWidget {
  @override
  _WantEatSteamedState createState() => _WantEatSteamedState();
}

class _WantEatSteamedState extends State<WantEatSteamed> {
  ...
  Future<void> readIwEatSteamed() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantsteamedF = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Foods')
        .doc('RaVbKkazEwiYqrQzMwWb')
        .collection('Steamed')
        .orderBy('Stid');

    await iwantsteamedF.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picsteamed = iwantModels[index].steamed_pic;
    ...
    if (picsteamed != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picsteamed != null ? Image.network(picsteamed) : Container(),
              ],
            ),
          ));
    } else if (picsteamed == null) {
      return Container(
  ...
  Widget showText(int index) {
    String iwsteamed = iwantModels[index].steamed_foods;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.steamed_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการกิน' + args.steamed_foods,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการกิน' + args.steamed_foods);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (isfav == true) {
                            var img = args.steamed_pic;
                            var message = 'ฉันต้องการกิน' + args.steamed_foods;
                            ...
                            var deleteImg = args.steamed_pic;
                            var delete = 'ฉันต้องการกิน' + args.steamed_foods;

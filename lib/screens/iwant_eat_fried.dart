...
class WantEatFried extends StatefulWidget {
  @override
  _WantEatFriedState createState() => _WantEatFriedState();
}

class _WantEatFriedState extends State<WantEatFried> {
  ...
  Future<void> readIwEatSt() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantSt = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Foods')
        .doc('Wrv5weOL0W8PInoXSLeW')
        .collection('Fried')
        .orderBy('Fdid');

    await iwantSt.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picfried = iwantModels[index].fried_pic;
    ...
    if (picfried != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picfried != null ? Image.network(picfried) : Container(),
              ],
            ),
          ));
    } else if (picfried == null) {
      return Container(
  ...
  Widget showText(int index) {
    String iwfried = iwantModels[index].fried_foods;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.fried_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการกิน' + args.fried_foods,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการกิน' + args.fried_foods);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (isfav == true) {
                            var img = args.fried_pic;
                            var message = 'ฉันต้องการกิน' + args.fried_foods;
                            ...
                            var deleteImg = args.fried_pic;
                            var delete = 'ฉันต้องการกิน' + args.fried_foods;
                            ;

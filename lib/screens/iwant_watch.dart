...
class WantWatch extends StatefulWidget {
  @override
  _WantWatchState createState() => _WantWatchState();
}

class _WantWatchState extends State<WantWatch> {
  ...
  Future<void> readIwWatch() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantWatch = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('WatchObj')
        .orderBy('Wcid');

    await iwantWatch.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picwatch = iwantModels[index].watchObj_pic;
    ...
    if (picwatch != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picwatch != null ? Image.network(picwatch) : Container(),
              ],
            ),
          ));
    } else if (picwatch == null) {
      return Container(
  ...
  Widget showText(int index) {
    String iwWatchObj = iwantModels[index].watchObj;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.watchObj_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการดู' + args.watchObj,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการดู' + args.watchObj);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (isfav == true) {
                            var img = args.watchObj_pic;
                            var message = 'ฉันต้องการดู' + args.watchObj;
                            ...
                            var deleteImg = args.watchObj_pic;
                            var delete = 'ฉันต้องการดู' + args.watchObj;

...
class _WantEatFruitsState extends State<WantEatFruits>{
  ...
  Future<void> readIwEatfruit() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantfruit = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Foods')
        .doc('AQNyhNraXeP0F9f830xh')
        .collection('Fruits')
        .orderBy('Fuid');

    await iwantfruit.snapshots().listen((response) {
  ...
  Widget showText(int index) {
    String iwfruit = iwantModels[index].fruits_foods;
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.fruits_pic,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการกิน' + args.fruits_foods);
                        },
                      ),
                    ],
                  ),

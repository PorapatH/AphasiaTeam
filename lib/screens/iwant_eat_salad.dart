...
class WantEatSalads extends StatefulWidget {
  @override
  _WantEatSaladsState createState() => _WantEatSaladsState();
}

class _WantEatSaladsState extends State<WantEatSalads> {
  ...
  Future<void> readIwEatsalad() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantsalad = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Foods')
        .doc('e5AUuZnE5cWyZ4mvMqK9')
        .collection('Salads')
        .orderBy('Slid');

    await iwantsalad.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picsalads = iwantModels[index].salads_pic;
    ...
    if (picsalads != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picsalads != null ? Image.network(picsalads) : Container(),
              ],
            ),
          ));
    } else if (picsalads == null) {
      return Container(
  ...
  Widget showText(int index) {
    String iwsalad = iwantModels[index].salads_foods;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.salads_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการกิน' + args.salads_foods,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการกิน' + args.salads_foods);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (isfav == true) {
                            var img = args.salads_pic;
                            var message = 'ฉันต้องการกิน' + args.salads_foods;
                            ...
                            var deleteImg = args.salads_pic;
                            var delete = 'ฉันต้องการกิน' + args.salads_foods;

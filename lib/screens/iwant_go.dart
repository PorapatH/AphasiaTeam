...
class WantGo extends StatefulWidget {
  @override
  _WantGoState createState() => _WantGoState();
}

class _WantGoState extends State<WantGo> {
  ...
  Future<void> readIwGo() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantGo = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Places')
        .orderBy('Plid');

    await iwantGo.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picplace = iwantModels[index].placepic;
    ...
    if (picplace != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picplace != null ? Image.network(picplace) : Container(),
              ],
            ),
          ));
    } else if (picplace == null) {
      return Container(
          width: MediaQuery.of(context).size.width * 0.4,
          height: MediaQuery.of(context).size.width * 0.4,
          child: Padding(
  ...
  Widget showText(int index) {
    String iwGoPl = iwantModels[index].place;
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.placepic,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการไป' + args.place);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (isfav == true) {
                            var img = args.placepic;
                            var message = 'ฉันต้องการไป' + args.place;
                            ...
                            var deleteImg = args.placepic;
                            var delete = 'ฉันต้องการไป' + args.place;

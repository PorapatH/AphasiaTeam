...
class WantRead extends StatefulWidget {
  @override
  _WantReadState createState() => _WantReadState();
}

class _WantReadState extends State<WantRead> {
  ...
  Future<void> readIwRead() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwantRead = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('ReadObj')
        .orderBy('Roid');

    await iwantRead.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String picread = iwantModels[index].readObj_pic;
    ...
    if (picread != null) {
      return Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                picread != null ? Image.network(picread) : Container(),
              ],
            ),
          ));
    } else if (picread == null) {
      return Container(
  ...
  Widget showText(int index) {
    String iwReadobj = iwantModels[index].readObj;
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.readObj_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการอ่าน' + args.readObj,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการอ่าน' + args.readObj);
                        },
                      ),
                    ],
                  ),

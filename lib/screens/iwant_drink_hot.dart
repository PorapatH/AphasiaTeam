...
class WantDrinkHot extends StatefulWidget{
  @override
  _WantDrinkHotState createState() => _WantDrinkHotState();
}
class _WantDrinkHotState extends State<WantDrinkHot> {
  ...
  Future<void> readIwHotDrink() async {
    FirebaseFirestore firestore = FirebaseFirestore.instance;
    var iwanthotDrink = firestore
        .collection('Iwant')
        .doc('av9GjXDgd6HdvekrXdNQ')
        .collection('Drinks')
        .doc('Cg9ZlzPvh9WiGIPtFvFf')
        .collection('Hotdrinks')
        .orderBy('Hdid');

    await iwanthotDrink.snapshots().listen((response) {
  ...
  Widget showImage(int index) {
    String pichotDrink = iwantModels[index].hotdrinks_pic;
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
        children: [
          pichotDrink!= null ? Image.network(pichotDrink) : Container(),
        ],
      ),)
    );
  }
  ...
  Widget showText(int index) {
    String iwdhotDrink = iwantModels[index].hotdrinks_drinks;
          ...
          appBar: new AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => WantDrinkHot()),
                );
              },
            ),
            title: const Text('Aphasia', style: TextStyle(color: Colors.black)),
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: <Widget>[
                      ClipRRect(
                        ...
                        child: Image.network(args.hotdrinks_pic,
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Text('ฉันต้องการดื่ม' + args.hotdrinks_drinks,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          tts.speak('ฉันต้องการดื่ม' + args.hotdrinks_drinks);
                        },
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      onPressed: () {
                        ...
                        if (isfav == true) {
                          var img = args.hotdrinks_pic;
                          var message = 'ฉันต้องการดื่ม' + args.hotdrinks_drinks;
                          ...
                          var deleteImg = args.hotdrinks_pic;
                          var delete = 'ฉันต้องการดื่ม' + args.hotdrinks_drinks;

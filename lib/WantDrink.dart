...
import 'package:intern/WantDrinkHot.dart';
import 'package:intern/WantDrinkIced.dart';

class WantDrink extends StatelessWidget {
  @override
              ...
              children: [
                        ...
                        children: [
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('      '),
                              Text('เครื่องดื่มร้อน', style: TextStyle(fontSize: 20, color: Colors.white)),
                            ],
                          ),
                        ],
                      ),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => WantDrinkIced()),
                    );
                  },
                  child: Card(
                    shape: RoundedRectangleBorder(
                        ...
                        children: [
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('      '),
                              Text('เครื่องดื่มเย็น', style: TextStyle(fontSize: 20, color: Colors.white)),
                            ],
                          ),
                        ],
                      ),
                        ...
                        children: [
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('      '),
                              Text('เครื่องดื่มปั่น', style: TextStyle(fontSize: 20, color: Colors.white)),
                            ],
                          ),
                        ],
                      ),

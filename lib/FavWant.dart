...
class FavWant extends StatelessWidget {
  @override
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text('ฉันต้องการ', style: TextStyle(fontSize: 30,),),
                  ],
                ),
                SizedBox(height: 20,),
                GestureDetector(
                        ...
                        children: [
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('      '),
                              Text('ฉันต้องการ 1', style: TextStyle(fontSize: 20, color: Colors.white)),
                              IconButton(
                                onPressed: (){},
                        ...
                        children: [
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('      '),
                              Text('ฉันต้องการ 2', style: TextStyle(fontSize: 20, color: Colors.white)),
                              IconButton(
                                onPressed: (){},
                                padding: new EdgeInsets.all(30.0),
                                icon: const Icon(Icons.delete_forever, color: Colors.white,),
                        ...
                        children: [
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('      '),
                              Text('ฉันต้องการ 3', style: TextStyle(fontSize: 20, color: Colors.white)),
                              IconButton(
                                onPressed: (){},
                                padding: new EdgeInsets.all(30.0),
                                icon: const Icon(Icons.delete_forever, color: Colors.white,),
